...
<img class="tennis" src={Tennis}/>
      ...
      <div class='portfolio-container' id='portfolio'>
        ...
        <div class="work-piece">
          ...
          <p>Developed a full-stack web-application using surge and heroku to host it on the internet. The front-end portion was built using React.js with react-router to create different pages as well desig using css. Used Ruby on Rails on the back end to create a database to store data from enrollment form. Configured DNS to netlify to host with a secure connection on the internet. Applied google analytics and running online promotion campaign. </p>
          <p class="highlights"> React.js</p>
            </div>
            <div class="work-piece">
